...
All input fields are strings, some of them with a specific format that they may follow.
...
The goal is to insert about ln(2)*1024 ones, which results in a Bloom filter with approximately half of the bits set to 1.

# Differential privacy

Each token is perturbed with a differential privacy mechanism that adds noise to the token.
...
Explanation of how bigrams are generated
